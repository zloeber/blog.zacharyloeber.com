...
This article will go over using a team of AI agents in conjunction with the [Terraform MCP server](https://github.com/hashicorp/terraform-mcp-server) and Docker's [cagent](https://github.com/docker/cagent) tool to clean up some rather gnarly autogenerated terraform without needing to write any code.
