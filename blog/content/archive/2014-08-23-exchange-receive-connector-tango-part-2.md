---
title: 'Exchange: Receive Connector Tango! – Part 2'
author: Zachary Loeber
type: post
date: 2014-08-23T21:20:31+00:00
url: /blog/2014/08/23/exchange-receive-connector-tango-part-2/
categories:
  - Active Directory
  - Exchange
  - Exchange 2010
...
---
[In part 1 of this series][1] I discussed some basic knowledge requirements to get a better grip on receive connectors in Exchange. I continue that conversation with some examples of improperly configured connectors and the issues they may cause. I finish up the discussion with a script you can use to scan your environment for such configurations. <!--more-->
...
This discussion has gone much longer than I originally anticipated. I hope people get some value from this. I always welcome comments, corrections, and script ideas. As usual, I&#8217;ve uploaded the script for this article to [the technet gallery][2] for your convenience.

 [1]: /2014/07/06/exchange-receive-connector-tango-part-1/
 [2]: http://gallery.technet.microsoft.com/Exchange-Receive-Connector-41d79197