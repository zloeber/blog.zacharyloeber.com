---
title: 'Lync Client: Automatic Fortune Cookie Utility'
author: Zachary Loeber
type: post
date: 2015-02-08T23:30:30+00:00
excerpt: Using powershell and the Lync SDK I create a personal note rotation utility for the Lync client much like the fortune unix utility.
url: /blog/2015/02/08/lync-client-automatic-fortune-cookie-utility/
categories:
  - Lync
  - Microsoft
  - Powershell
...
This ended up being only slightly more involved than I initially imagined. With the [Lync SDK installed][2] you can grab running instances of the client, check the login status, update personal contact information, and a slew of other tasks much in the same way you can instantiate instances of Outlook or Word. Here is a function I put together which grabs any number of your personal contact information properties using the SDK and a little bit of clever enumeration.
...
I&#8217;ve also used a [customized version of the reverse function found here][3] for publishing the lync contact information. I then wrapped everything up with a few functions I created; [get-iQuote][4], [Load-LyncSDK][5], [New-ScheduledPowershellTask][6]. I also included a small sampling of [example quotes][7] to use if you wanted to not use iQuote for the quote source.

## Requirements/Notes

  * The Lync SDK is an obvious requirement. You can save yourself the hassle of installing all the visual studio bits (which forces you to install the silverlight SDK as well) of the SDK by following the [directions found here][8]. Here are the relevant notes on how that is done:

>   * Download the <a href="http://www.microsoft.com/en-us/download/details.aspx?id=36824" target="_blank">Lync SDK</a>
...
The script and example quote file can be downloaded from the [Microsoft Technet Gallery][9] (please rate it if you like it!) or from my [Github repository][10]. I hope the community enjoys this goofy little experiment of mine as much as I enjoyed creating it.
...
<div id="attachment_1394" style="width: 245px" class="wp-caption aligncenter">
 ...
 [1]: http://en.wikipedia.org/wiki/Fortune_%28Unix%29
 [2]: http://www.microsoft.com/en-us/download/details.aspx?id=36824
 [3]: http://blog.powershell.no/2013/08/08/automating-microsoft-lync-using-windows-powershell/
 [4]: https://github.com/zloeber/Powershell/blob/master/Supplemental/Get-iQuote.ps1
 [5]: https://github.com/zloeber/Powershell/blob/master/Lync/SDK/Load-LyncSDK.ps1
 [6]: https://github.com/zloeber/Powershell/blob/master/Supplemental/New-ScheduledPowershellTask.ps1
 [7]: https://github.com/zloeber/Powershell/blob/master/Lync/LyncFortuneCookie/example-quotes.txt
 [8]: http://msunified.net/2013/11/14/control-your-lync-presence-during-a-pomodoro-sprint-using-powershell/
 [9]: https://gallery.technet.microsoft.com/Lync-Client-Automatic-757ac43c
 [10]: https://github.com/zloeber/Powershell/tree/master/Lync/LyncFortuneCookie